        ...
        >
          ...
          {activeTab === "overview" && (
            <>
              ...
              {!loading && error && (
                <div className="flex flex-col items-center justify-center py-16 text-center gap-3 rounded-2xl border border-rose-500/20 bg-rose-500/5">
                  <X className="w-8 h-8 text-rose-400" />
                  <p className="text-sm font-semibold text-rose-200">Unable to load SportsHub</p>
                  <p className="max-w-sm text-xs text-gray-400">{error}</p>
                  {onRetry && (
                    <button onClick={onRetry} className="mt-1 inline-flex items-center gap-2 rounded-lg border border-primary/30 bg-primary/15 px-4 py-2 text-xs font-bold text-white transition-colors hover:bg-primary/25">
                      <RefreshCw size={14} />
                      Try again
                    </button>
                  )}
              ...
              {!loading && !error && overviewLive.length === 0 && overviewUpcoming.length === 0 && overviewResults.length === 0 && (
